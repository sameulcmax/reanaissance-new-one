...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-[var(--renaissance-blue)] text-white"
          ...
          <div className="mt-14 space-y-8">
            <Reveal delay={0.25}>
              ...
              <div className="mt-2 flex flex-col gap-3">
                {BRAND.email.map((email) => (
                  <a
                    key={email}
                    href={`mailto:${email}`}
                    className="block font-display text-2xl text-white transition-opacity hover:opacity-70 md:text-3xl"
                    data-cursor="hover"
                  >
                    {email}
                  </a>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-6 pt-2">
                      ...
                      <MagneticButton 
                        ...
                        size="lg" 
                        variant="outline"
                        className="border-white/30 text-[var(--renaissance-blue)] hover:bg-white hover:text-[var(--renaissance-blue)] hover:border-white"
                      >
