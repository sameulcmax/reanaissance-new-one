        ...
        <div className="grid gap-10 md:grid-cols-12 items-start">
          <div className="md:col-span-3 space-y-2">
            {FOOTER_LINKS[0].map((l) => (
              <a
                key={l}
                href="#"
                className="block border-t border-white/15 py-3 font-bold hover:text-white/80 transition-colors"
              >
                {l}
              </a>
            ))}
          ...
          <div className="md:col-span-3">
            ...
            >
              ...
              <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-ink text-background group-hover:bg-white group-hover:text-ink transition-colors">
                →
              </span>
            </a>
